...
-- Description: Create initial database schema for Hedera Flow MVP
-- Created: February 19, 2026
-- 
-- NOTE: This file has been converted to Alembic format.
-- Use the Alembic migration system instead:
--   python scripts/migrate.py upgrade head
-- 
-- See: backend/migrations/versions/20260219_001_initial_schema.py
-- See: backend/MIGRATIONS.md for complete guide
